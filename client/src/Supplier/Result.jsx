import { Download, Edit, Eye, MessageCircle, Plus, Search } from 'lucide-react'
...
const handleDownloadPdf = (resultId) => {
  ...
  return (
     <div className="space-y-6">
      <div className="flex items-center justify-between">
        <p className="text-xl font-semibold text-gray-900">My Results</p>
 ...
 <div className="bg-white rounded-xl max-w-full shadow-sm">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {recentRequests.map((request) => (
                <tr key={request.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-gray-900">{request.methodology}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-gray-500">{request.date}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-gray-900">{request.technician}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
