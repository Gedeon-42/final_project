    ...
    <div className="fixed z-[50] top-0 left-0 right-0 bottom-0 flex justify-center items-center">
      ...
      <form className="relative z-[60] space-y-4 bg-white p-6 rounded shadow-lg w-[90%] max-w-lg">
        ...
        <div className="flex flex-col gap-[10px]">
          <h1 className="border-b border-gray-400  text-white p-[7px] mt-[20px] pb-[10px] bg-gray-500">
            Suppier Informtion
          </h1>
          ...
          <h1 className="border-b border-gray-400 mt-[20px] text-white p-[7px] bg-gray-400">
            Result Information
          </h1>
          <div className="flex items-center gap-[4px]">
            <h1>Mineral:</h1>
