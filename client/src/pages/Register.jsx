  ...
  return (
    ...
    <form action="" className="flex flex-col gap-[20px]">
       <div className="relative flex items-center">
          ...
          <input type="text" placeholder="Company Name" className="bg-gray-300 w-full pl-[30px] pt-[7px] pb-[7px] rounded-[5px] border-[1px] border-[lightgrey]" />
          </div>
        <div className="relative flex items-center">
        ...
        <input type="text" placeholder="Phone Number" className="bg-gray-300 w-full pl-[30px] pt-[7px] pb-[7px] rounded-[5px] border-[1px] border-[lightgrey]" />
        </div>
        <div className="relative flex items-center">
